...
public class UDPServerSocket {
    ...
    public DatagramPacket readPacket() throws IOException {
        ...
        //MainLogger.logger.debug(TextFormat.YELLOW + "In: " + Binary.bytesToHexString(packet.getData(), true));
        return packet;
    ...
    public int writePacket(byte[] data, InetSocketAddress dest) throws IOException {
        //MainLogger.logger.debug(TextFormat.AQUA + "Out: " + Binary.bytesToHexString(data, true));
