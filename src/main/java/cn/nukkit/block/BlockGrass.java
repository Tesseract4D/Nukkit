...
public class BlockGrass extends BlockDirt {
    ...
    public int onUpdate(int type) {
        if (type == Level.BLOCK_UPDATE_RANDOM) {
            ...
            if (light < 4 || !lv.getBlock(new Vector3(this.x, this.y + 1, this.z)).isTransparent()) {
                ...
                for (int l = 0; l < 4; ++l) {
                    ...
                    if (blocks.getId() == Block.DIRT && blocks.getDamage() == 0 && lv.getLightAt(x, y, z) >= 4 && blocks.getSide(1).isTransparent()) {
